...
\title{\LARGE{Interview mit \\ Prof. Vivien Petras, PhD und Prof. Dr. Elke Greifeneder}}% title
\author{Thomas Roesnick (Interviewer) \\ Felicitas Härting \& Miriam Brauer (Transkription und Korrektur)} % author

\setcounter{page}{1}

\hypersetup{%
      pdftitle={Interview mit Prof. Vivien Petras, PhD und Prof. Dr. Elke Greifeneder},
